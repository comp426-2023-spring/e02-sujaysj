...
export const rps = (data) => {
    ...
    if (data !== undefined) {
        ...
        if (rpsRules[player_choice] == opponent_choice) {
            ...
            output.debug_pchoice = player_choice;
            output.debug_ochoice = opponent_choice;
            output.debug_pchoice_t = rpsRules.player_choice;
            output.debug_ochoice_t + rpsRules.opponent_choice;
            output.result = "tie"
        }
        return output
    } else {
